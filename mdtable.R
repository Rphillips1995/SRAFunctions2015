#' Decreases number of NAs in the sample origin column and returns the 
#' sample origin that is unique/specific to that cell line. 
#' 
#' This function first builds a dataframe that contains information on whether or not the cell lines matched one of the 
#' cell lines matched one of the cell lines in the reference table. The function then edits the sample origin column
#' based on the whether or not the cell lines matched up. Finally, the function will return the sample origin that is 
#' unique/specific to that cell line. 
#'
...
mdtable <- function(cell_line_name){
